 ...
 * @author Rafael Math
 */
public class ColorDepthDropDownViewConverter implements DropDownViewConverter<ColorDepthDropDownModel> 
{
	@Override
	public void display(Element element, ColorDepthDropDownModel item) 
	{
	...
	@Override
	public int getWidth(Element element, ColorDepthDropDownModel item) 
	{
		TextRenderer renderer = element.getRenderer(TextRenderer.class);
		if (renderer == null) 
		{
