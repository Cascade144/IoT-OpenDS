 ...
 * @author Rafael Math
 */
public class FrequencyDropDownViewConverter implements DropDownViewConverter<FrequencyDropDownModel> 
{
	@Override
	public void display(Element element, FrequencyDropDownModel item) 
	{
	...
	@Override
	public int getWidth(Element element, FrequencyDropDownModel item) 
	{
		TextRenderer renderer = element.getRenderer(TextRenderer.class);
		if (renderer == null) 
		{
