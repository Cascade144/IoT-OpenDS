...
public class LaneChangeReactionTimer extends ReactionTimer
{
	...
	public void setup(String newReactionGroupID, String startLane, String targetLane, 
			...
			boolean allowBrake, float holdLaneFor, String failSound, String successSound, String newComment, String driverStats)
	{
		// check pre-condition
		if(startLane.equals(getCurrentLane()))
		{
			super.setup(newReactionGroupID, newComment, driverStats);
