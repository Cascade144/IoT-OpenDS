...
public abstract class ReactionTimer
{
	...
	public void setup(String newReactionGroupID, String newComment, String newDriverStats)
	{
		if(timerIsActive)
		...
		resetTimer();
		System.out.println("Creating trial logger.");
		trialLogger = new TrialLogger(newReactionGroupID, comment, driverStats);
